...
export class ResponseLogger {
    ...
    public logProxyRequest(siteUrl: string, method: string, endpoint: string, statusCode: number, requestData?: any, responseData?: any, error?: string, userId?: string) {
        this.loggingService.logApiCall(siteUrl, method, endpoint, statusCode, requestData, responseData, error, userId);
    }
}